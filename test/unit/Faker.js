...
describe('Fake Transport', function () {
  ...
  describe('Delivery Reports', function () {
    ...
    it(
      'should return current SMS sent delivery report(s) based on messageId provided',
      function (done) {
        var options = {
          messageId: '80664c0c-e1ca-414d-806a-5caf146463df'
        };

        transport.getDeliveryReports(options, function (error,
          deliveryReport) {
    ...
    it(
      'should return current SMS sent delivery report(s) based on bulkId provided',
      function (done) {
        var options = {
  ...
  describe('Received SMS', function () {
    ...
    it('should return received SMS(s) based on options provided',
      function (done) {
  ...
  describe('Received SMS Log', function () {
    ...
    it('should return received SMS(s) log based on options provided',
      function (done) {
  ...
  describe('Send Single Textual SMS', function () {
    ...
    it('should send a single sms to a single destination', function (
      done) {
    ...
    it('should send a single sms to multiple destination', function (
      done) {
  ...
  describe('Sent SMS Log', function () {
    ...
    it('should return current SMS sent logs based on options provided',
      function (done) {
