...
var single =
    require(path.join(__dirname, 'fixtures', 'send_single_one_destination_response.json'));
var multi =
    require(path.join(__dirname, 'fixtures', 'send_single_multi_destination_response.json'));
