...
var sms =
  require(path.join(__dirname, 'fixtures',
    'fully_featured_textual_message_request.json'));

var featured =
  require(path.join(__dirname, 'fixtures',
    'send_fully_featured_textual_message_response.json'));
...
describe('Send Featured SMS', function () {
  ...
  it('should have /sms/1/text/advanced as send single sms url', function (
    done) {
